...
- [x] Project identity: **Klingon Translator**
- [x] Firefox Manifest V3 scaffold
- [x] Minimal `activeTab` + `scripting` permission model
- [x] Floating Shadow DOM panel scaffold
- [x] Local engine codename: `mughwI'`
...
- [ ] Add polished loading / copy / error states
...
## M4 — Extended Trekker features

- [ ] Klingon → EN-US / PT-BR exploration
- [ ] Optional pIqaD output
- [ ] Copy variants and transliteration controls
- [ ] User-selectable translation detail / confidence view
